...
// Note that the DOM is cross-platform and language-independent ways of manipulating HTML and XML document.
...
// getElementByClassName() - select element by one or more class names.
// querySelector() - select element CSS selectors.
...
{
    // document.getElementById("dem4").innerHTML = "Number of scripts: " + document.scripts.length;
}
